            ...
            <div className="column is-4 is-offset-4">
              ...
              <div className="field">
                <div className="control has-icons-right">
                  <AuthInput className="input" type="name" placeholder="Full Name" />
                </div>
              </div>
              ...
              <div className="control">
                <AuthButton className="button is-dark is-fullwidth has-text-weight-semibold">Create account</AuthButton>
              </div>
